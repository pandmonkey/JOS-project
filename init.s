...
.LM34:
	subq	$24, %rsp
	.cfi_def_cfa_offset 32
	.stabn	68,0,24,.LM35-.LFBB2
.LM35:
	movq	%fs:40, %rax
	movq	%rax, 8(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,30,.LM36-.LFBB2
.LM36:
	call	memset@PLT
	.stabn	68,0,34,.LM37-.LFBB2
.LM37:
	call	cons_init@PLT
	.stabn	68,0,36,.LM38-.LFBB2
.LM38:
	movl	$6828, %esi
	leaq	.LC2(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
	.stabn	68,0,40,.LM39-.LFBB2
.LM39:
	movl	$4, %ecx
	xorl	%eax, %eax
	movl	$3, %edx
	...
	leaq	.LC3(%rip), %rdi
	call	cprintf@PLT
	.stabn	68,0,47,.LM40-.LFBB2
.LM40:
	leaq	4(%rsp), %rdx
	movl	$57616, %esi
	xorl	%eax, %eax
	leaq	.LC4(%rip), %rdi
	.stabn	68,0,46,.LM41-.LFBB2
.LM41:
	movl	$6581362, 4(%rsp)
	.stabn	68,0,47,.LM42-.LFBB2
.LM42:
	call	cprintf@PLT
	.stabn	68,0,51,.LM43-.LFBB2
.LM43:
	leaq	.LC5(%rip), %rdi
	movl	$3, %esi
	xorl	%eax, %eax
	call	cprintf@PLT
	.stabn	68,0,55,.LM44-.LFBB2
.LM44:
	movl	$5, %edi
	call	test_backtrace
	.p2align 4,,10
...
.LFE1:
	...
	.stabs	"i:(0,3)=r(0,3);0;4294967295;",128,0,0,4
...
.LC7:
	...
	.stabs	"file:P(0,4)=*(0,5)=r(0,5);0;127;",64,0,0,5
	.stabs	"line:P(0,2)",64,0,0,4
	.stabs	"fmt:P(0,4)",64,0,0,6
...
.LFB2:
	...
	movaps	%xmm7, 192(%rsp)
.L19:
	.stabn	68,0,75,.LM47-.LFBB3
.LM47:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,78,.LM48-.LFBB3
.LM48:
	cmpq	$0, panicstr(%rip)
	je	.L24
	.p2align 4,,10
	.p2align 3
.L21:
	.stabn	68,0,94,.LM49-.LFBB3
.LM49:
	xorl	%edi, %edi
	call	monitor@PLT
	jmp	.L21
.L24:
	.stabn	68,0,80,.LM50-.LFBB3
.LM50:
	movq	%rbp, panicstr(%rip)
	.stabn	68,0,83,.LM51-.LFBB3
.LM51:
#APP
# 83 "kern/init.c" 1
	cli; cld
# 0 "" 2
	.stabn	68,0,85,.LM52-.LFBB3
.LM52:
#NO_APP
	leaq	224(%rsp), %rax
	.stabn	68,0,86,.LM53-.LFBB3
.LM53:
	movl	%esi, %edx
	movq	%rdi, %rsi
	.stabn	68,0,85,.LM54-.LFBB3
.LM54:
	movl	$24, (%rsp)
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,86,.LM55-.LFBB3
.LM55:
	leaq	.LC6(%rip), %rdi
	.stabn	68,0,85,.LM56-.LFBB3
.LM56:
	movq	%rax, 16(%rsp)
	.stabn	68,0,86,.LM57-.LFBB3
.LM57:
	xorl	%eax, %eax
	.stabn	68,0,85,.LM58-.LFBB3
.LM58:
	movl	$48, 4(%rsp)
	.stabn	68,0,86,.LM59-.LFBB3
.LM59:
	call	cprintf@PLT
	.stabn	68,0,87,.LM60-.LFBB3
.LM60:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,88,.LM61-.LFBB3
.LM61:
	leaq	.LC7(%rip), %rdi
	xorl	%eax, %eax
	call	cprintf@PLT
...
.LFE2:
	.size	_panic, .-_panic
	.stabs	"ap:(0,6)=(0,7)=(0,8)=ar(0,9)=r(0,9);0;-1;;0;0;(0,10)=xs__va_list_tag:",128,0,0,0
	.stabs	"va_list:t(0,6)",128,0,0,0
	.stabs	"__builtin_va_list:t(0,7)",128,0,0,0
	.stabs	"__va_list_tag:t(0,10)=s24gp_offset:(0,3),0,32;fp_offset:(0,3),32,32;overflow_arg_area:(0,11)=*(0,1),64,64;reg_save_area:(0,11),128,64;;",128,0,0,0
...
.LC8:
	...
	.stabs	"file:P(0,4)",64,0,0,10
	.stabs	"line:P(0,2)",64,0,0,11
	.stabs	"fmt:P(0,4)",64,0,0,6
	.globl	_warn
	.type	_warn, @function
_warn:
	.stabn	68,0,100,.LM62-.LFBB4
.LM62:
.LFBB4:
.LFB3:
	.cfi_startproc
	...
	movaps	%xmm7, 192(%rsp)
.L26:
	.stabn	68,0,100,.LM63-.LFBB4
.LM63:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,103,.LM64-.LFBB4
.LM64:
	leaq	224(%rsp), %rax
	.stabn	68,0,104,.LM65-.LFBB4
.LM65:
	movq	%r10, %rsi
	movl	%r11d, %edx
	.stabn	68,0,103,.LM66-.LFBB4
.LM66:
	movq	%rax, 8(%rsp)
	leaq	32(%rsp), %rax
	.stabn	68,0,104,.LM67-.LFBB4
.LM67:
	leaq	.LC8(%rip), %rdi
	.stabn	68,0,103,.LM68-.LFBB4
.LM68:
	movq	%rax, 16(%rsp)
	.stabn	68,0,104,.LM69-.LFBB4
.LM69:
	xorl	%eax, %eax
	.stabn	68,0,103,.LM70-.LFBB4
.LM70:
	movl	$24, (%rsp)
	movl	$48, 4(%rsp)
	.stabn	68,0,104,.LM71-.LFBB4
.LM71:
	call	cprintf@PLT
	.stabn	68,0,105,.LM72-.LFBB4
.LM72:
	movq	%rbp, %rdi
	movq	%rsp, %rsi
	call	vcprintf@PLT
	.stabn	68,0,106,.LM73-.LFBB4
.LM73:
	xorl	%eax, %eax
	leaq	.LC7(%rip), %rdi
	call	cprintf@PLT
	.stabn	68,0,108,.LM74-.LFBB4
.LM74:
	movq	24(%rsp), %rax
	subq	%fs:40, %rax
	jne	.L29
